...
# Run this code first before 'curl_caller_6_15.py' code. It loads the whole semanctic static router on Ollama server that runs on fastAPI web server
...
# Configuration 3: 
# Route = 6 | Utterances per route = 15
# Routes: physics, biology, history, philosophy, chemistry, computer
